...
{
    /// <inheritdoc />
    public partial class AddCatalogAndStoreEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductGalleries_MediaImages_MediaImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    SkuCode = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_DomainUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductGalleries_MediaImageId",
                table: "ProductGalleries",
                column: "MediaImageId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductGalleries_ProductId_DisplayOrder",
                table: "ProductGalleries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Skus_ProductId_SkuCode",
                table: "Skus",
